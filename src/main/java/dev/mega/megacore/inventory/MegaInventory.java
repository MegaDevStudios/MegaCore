...
/**
 * Code was taken from https://github.com/MrMicky-FR/MegaInventory/blob/master/src/main/java/fr/mrmicky/MegaInventory/MegaInventory.java
 */

public class MegaInventory implements InventoryHolder {
     ...
     */
    public MegaInventory(int size, String title) {
     ...
     */
    public MegaInventory(InventoryType type) {
    ...
    public MegaInventory(Function<InventoryHolder, Inventory> inventoryFunction) {
        ...
        if (inv.getHolder() != this) {
            throw new IllegalStateException("Inventory holder is not MegaInventory, found: " + inv.getHolder());
        }
